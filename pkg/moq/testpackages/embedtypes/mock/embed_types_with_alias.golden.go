...
// Ensure, that Alias does implement embedtypes.Interface3.
// If this is not the case, regenerate this file with moq.
var _ embedtypes.Interface3 = &Alias{}

// Alias is a mock implementation of embedtypes.Interface3.
//
//	func TestSomethingThatUsesInterface3(t *testing.T) {
//
//		// make and configure a mocked embedtypes.Interface3
//		mockedInterface3 := &Alias{
...
func (mock *Alias) ExportedMethod() {
	if mock.ExportedMethodFunc == nil {
		panic("Alias.ExportedMethodFunc: method is nil but Interface3.ExportedMethod was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *Alias) ExportedMethodCalls() []struct {
} {
	var calls []struct {
	}
